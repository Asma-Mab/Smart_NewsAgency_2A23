...
void gestion_employe::on_pb_ajouter_clicked()
{
...
void gestion_employe::on_pb_ajouter_2_clicked()
{
...
void gestion_employe::on_pb_supprimer_2_clicked()
{
...
void gestion_employe::on_pb_modifier_clicked()
{
    int idemploye = ui->lineEdit_num->text().toInt();
    QString firstname= ui->lineEdit_num_3->text();
    QString lastname= ui->lineEdit_num_2->text();
...
void gestion_employe::on_pb_modifier_4_clicked()
{
...
void gestion_employe::on_pb_rechercher_clicked()
{
...
void gestion_employe::on_tabchambre_activated(const QModelIndex &index)
{
...
void gestion_employe::on_lineEdit_prix_cursorPositionChanged(int arg1, int arg2)
{

}

void gestion_employe::on_lineEdit_num_cursorPositionChanged(int arg1, int arg2)
{
...
void gestion_employe::on_tabservicech_activated(const QModelIndex &index)
{
...
void gestion_employe::on_radioMale_2_clicked()
{
     ui->lineEdit_dispo->setText("oui");
}

void gestion_employe::on_radioFemelle_2_clicked()
{
...
void gestion_employe::on_pushButton_clicked()
{
        ...
        QString str1=ui->lineEdit_prix_2->text();

        ui->tabservicech->setModel(tmpservicech.modifier_5(str,str1));

}

void gestion_employe::on_comboBox_2_activated(const QString &arg1)
{

}

void gestion_employe::on_pb_supprimer_3_clicked()
{
    /*  QPrinter printer;
          QString doc;
...
void gestion_employe::on_pb_supprimer_4_clicked()
{
