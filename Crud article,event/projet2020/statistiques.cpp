    ...
    ui(new Ui::Statistiques)
{
    ...
    nuclear->moveAbove(fossil);
      ...
      query.prepare("SELECT DISTINCT idarticle FROM article");
      query.exec();
      ...
      while(query.next())
      {
       ...
       query1.prepare("SELECT idarticle FROM article where idarticle = '"+query.value(0).toString()+"' ");
       query1.exec();
       while (query1.next()) {
         fossilData.append(query1.value(0).toDouble());
       }
       query2.prepare("SELECT contenuarticle FROM article where idarticle = '"+query.value(0).toString()+"' ");
       query2.exec();
       while (query2.next()) {
